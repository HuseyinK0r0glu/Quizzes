/**
 * RectangularBuilder class that implements Builder interface and designs the rectangular classrooms.
 */
public class RectangularBuilder implements Builder{
    ...
    /**
     * Designs the walls of rectangular classrooms and the results to output file.
    ...
    public void designWalls(String classroom,String wallDecorate,String outputFile) {
        ...
        if(wallDecorate.split("\t")[2].equals("Tile")){
            ...
            FileIO.writeToFile(outputFile,"Classroom " + classroom.split("\t")[1] + " used " + (int) area + "m2 of " +
    ...
    /**
     * Designs the floor of rectangular classrooms and writes the result to output file.
     * @param classroom     Information about the classroom.
    ...
    /**
     * Calculates the area of the walls of the rectangular classroom.
     * @param classroom Information about the classroom.
    ...
    public double getAreaForWall(String classroom) {
        ...
        return 2 * (Integer.parseInt(classInfo[3]) + Integer.parseInt(classInfo[4])) * Integer.parseInt(classInfo[5]);
    }
    ...
    public double getAreaForFloor(String classroom) {
        String[] classInfo = classroom.split("\t");
        return Integer.parseInt(classInfo[3]) * Integer.parseInt(classInfo[4]);
    }
}
